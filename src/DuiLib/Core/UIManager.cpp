...
HFONT CPaintManagerUI::AddNewFont(int id, LPCTSTR pStrFontResource,LPCTSTR pStrFontName, int nSize, bool bBold, bool bUnderline, bool bItalic, bool bShared)
{
	CDuiString pFontStrResourcePath = m_pStrResourcePath + pStrFontResource;

	int bret = ::AddFontResourceEx(pFontStrResourcePath, FR_PRIVATE,0);
