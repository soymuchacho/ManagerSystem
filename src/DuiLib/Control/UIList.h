...
class CListHeaderItemUIEx;

class DUILIB_API CListUIEx : public CListUI
{
public:
	CListUIEx();
	...
	BOOL InsertColumn(int nCol, CListHeaderItemUIEx *pHeaderItem);
...
// 2017/4/13 扩展的CListHeaderItemUIEx
// CListHeaderItemUIEx 为了能支持在其中显示其他控件，它需要时一个容器，
// 因此将父类改成CContainerUI

class DUILIB_API CListHeaderItemUIEx : public CContainerUI
{
public:
	CListHeaderItemUIEx();
...
class DUILIB_API CListContainerElementUIEx : public CListContainerElementUI
{
public:
